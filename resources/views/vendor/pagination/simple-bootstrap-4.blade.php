...
<nav class="flexbox mt-30">
     ...
     <a class="btn btn-white" href="{{ $paginator->nextPageUrl() }}">Newer <i class="ti-arrow-right fs-9 ml-4"></i></a>
     @else
     <a class="btn btn-white">Newer <i class="ti-arrow-right fs-9 ml-4"></i></a>
     @endif
 </nav>
