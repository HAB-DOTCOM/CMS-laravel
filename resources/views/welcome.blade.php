          ...
          <div class="row">
                ...
                @forelse($posts as $post)
                  ...
                  <div class="card border hover-shadow-6 mb-6 d-block">
                    ...
                    <div class="p-6 text-center">
                      <p><a class="small-5 text-lighter text-uppercase ls-2 fw-400" href="#">{{$post->catagory->name}}</a></p>
            ...
            <div class="col-md-4 col-xl-3">
              <div class="sidebar px-4 py-md-0">
                ...
                <form class="input-group" method="{{route('welcome')}}" method="GET">
                ...
                <div class="row link-color-default fs-14 lh-24">
                  @foreach($catagories as $catagory)
                    <div class="col-6"><a href="{{route('blog.catagory',$catagory->id)}}">
                      {{$catagory->name}}
                    </a></div>
                  @endforeach
                </div>
